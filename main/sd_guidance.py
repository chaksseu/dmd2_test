...
class SDGuidance(nn.Module):
    def __init__(self, args, accelerator):
        ...
        self.real_unet = UNet2DConditionModel.from_pretrained(
            "/home/work/StableDiffusion/DMD2/checkpoint-300000", # "CompVis/stable-diffusion-v1-4"#  args.model_id # /home/work/StableDiffusion/DMD2/checkpoint-300000
            subfolder="unet"
        ).float()
        ...
        self.scheduler = DDIMScheduler.from_pretrained(
            args.model_id, # "CompVis/stable-diffusion-v1-4" #  args.model_id
            subfolder="scheduler"
        )
